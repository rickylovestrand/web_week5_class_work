...
let euros = 100
let exRate = rates.AUD
let ausDollars = euros * exRate
...
console.log(largestCurrency + ' ' + largestRate)
...
cats_and_owners.forEach(function(kittyCouple){
    console.log(kittyCouple.name + "\'s cat is called " + kittyCouple.cat)
})
...
nobel_prize_winners_2017.prizes[0].laureates.forEach(function(laureate){
...
let laureateCount = 0
nobel_prize_winners_2017.prizes.forEach(function(prize){
    laureateCount += prize.laureates.length
})

console.log('There are a total of ' + laureateCount + ' laureates in 2017')
